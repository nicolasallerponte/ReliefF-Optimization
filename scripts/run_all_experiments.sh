...
echo "============================================================"
echo ""
echo "Duración estimada: ~90 minutos"
echo "Experimentos: 01 al 10 en secuencia"
echo ""
...
ejecutar "01/10" "experimentos/01_busqueda_hiperparametros.py" \
    "Búsqueda de hiperparámetros - ANN y Proto"

ejecutar "02/10" "experimentos/02_linea_base.py" \
    "Línea base - ReliefF vs ANN vs Proto en 12 datasets"

ejecutar "03/10" "experimentos/03_robustez.py" \
    "Robustez ante ruido - CorrAL-100 (4 tipos)"

ejecutar "04/10" "experimentos/04_escalabilidad.py" \
    "Escalabilidad temporal - O(n) vs O(n²)"

ejecutar "05/10" "experimentos/05_trampa_corral100.py" \
    "Feature trampa/correlacionada - CorrAL-100"

ejecutar "06/10" "experimentos/06_analisis_estadistico.py" \
    "Análisis estadístico - Wilcoxon + Friedman + Nemenyi + Cohen's d"

ejecutar "07/10" "experimentos/07_convergencia_iter_ratio.py" \
    "Convergencia del iter_ratio - ANN"

ejecutar "08/10" "experimentos/08_huella_carbono.py" \
    "Huella de carbono - Green AI (Cátedra Inditex-UDC)"

ejecutar "09/10" "experimentos/09_estabilidad_seleccion.py" \
    "Estabilidad de la selección - Índice de Kuncheva"

ejecutar "10/10" "experimentos/10_sensibilidad_k.py" \
