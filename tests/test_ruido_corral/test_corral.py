...
algos = [
    (ReliefF_Original(n_neighbors=10, n_features_to_select=10), 
     'ReliefF'),
...
for noise in noise_levels:
    ...
    for selector, name in algos:
        ...
        results_noise[name].append(res['acc'])
...
n_random_list = [10, 20, 50, 100, 200, 500, 1000]
...
for n_rand in n_random_list:
    ...
    for selector, name in algos:
        ...
        results_dilution[name].append(res['acc'])
        print(f"  {name:15s}: F1={res['f1']:.2f}, Acc={res['acc']:.3f}")
    print()
