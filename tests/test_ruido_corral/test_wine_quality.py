...
algos = [
    (ReliefF_Original(n_neighbors=10, n_features_to_select=n_select), 
     'ReliefF'),

    (ANN(n_neighbors=10, n_features_to_select=n_select, 
            iter_ratio='auto', metric='euclidean'),
     'ANN'),

    (Proto(n_features_to_select=n_select, sigma=0.1, k_protos=5,
              use_lvq=False, metric='euclidean'),
     'Proto'),
]
