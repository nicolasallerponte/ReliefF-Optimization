...
# Algoritmos
algos = [
    (ReliefF_Original(n_neighbors=5, n_features_to_select=10), 'ReliefF'),
    (ANN(n_neighbors=5, n_features_to_select=10, iter_ratio=1.0,
            metric='euclidean'), 'ANN'),
    (Proto(n_features_to_select=10, sigma=0.15, k_protos=3,
              use_lvq=False, metric='euclidean'), 'Proto'),
]
